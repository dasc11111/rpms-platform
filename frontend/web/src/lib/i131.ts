...
export type I131Record = {
    ...
    identidad_confirmada: boolean | null;
    embarazo_descartado: string | null;
    fecha_test_embarazo: string | null;
    lactancia_consultada: string | null;
    segunda_verificacion_responsable: string | null;
    bloqueo_tiroideo_considerado: string | null;
    actividad_dentro_tolerancia: boolean | null;
    informacion_radioproteccion_entregada: boolean | null;
    created_at: string;
    updated_at: string;
};
