                                                                                                                                                                                                                ...
                                                                                                                                                                                                                usuario TEXT,
                                                                                                                                                                                                                      observaciones TEXT,
                                                                                                                                                                                                                            created_at TIMESTAMPTZ NOT NULL DEFAULT now()
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  `;
      // Migracion aditiva (seccion 22-24, Motor 2): se necesita el tiempo de
  // fondo por separado del tiempo de conteo bruto para poder calcular el
  // umbral de decision / limite de deteccion de Currie. No se elimina ni
  // renombra tiempo_medicion_s (se mantiene como tiempo de conteo bruto).
  await sql`ALTER TABLE waste_item_measurements ADD COLUMN IF NOT EXISTS tiempo_fondo_s NUMERIC`;
