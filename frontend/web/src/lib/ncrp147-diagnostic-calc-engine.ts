 ...
 * 133-134 (Tabla B.1) y 147-148 (Tabla C.1). Todos los coeficientes fueron
 * transcritos directamente del documento original y verificados visualmente
 * (zoom) linea por linea. NO se han inventado, interpolado ni estimado
 * valores numericos.
 *
