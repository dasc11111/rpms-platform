...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const partida = body.partida ?? current.partida;
    ...
    const tipo_procedimiento = body.tipo_procedimiento ?? current.tipo_procedimiento;
    const identidad_confirmada = body.identidad_confirmada ?? current.identidad_confirmada;
    const embarazo_descartado = body.embarazo_descartado ?? current.embarazo_descartado;
    const fecha_test_embarazo = body.fecha_test_embarazo ?? current.fecha_test_embarazo;
    const lactancia_consultada = body.lactancia_consultada ?? current.lactancia_consultada;
    const segunda_verificacion_responsable = body.segunda_verificacion_responsable ?? current.segunda_verificacion_responsable;
    const bloqueo_tiroideo_considerado = body.bloqueo_tiroideo_considerado ?? current.bloqueo_tiroideo_considerado;
    const actividad_dentro_tolerancia = body.actividad_dentro_tolerancia ?? current.actividad_dentro_tolerancia;
    const informacion_radioproteccion_entregada = body.informacion_radioproteccion_entregada ?? current.informacion_radioproteccion_entregada;
                                                                                                                                                ...
                                                                                                                                                dedupe_key = ${dedupeKey},
                                                                                                                                                      tipo_procedimiento = ${tipo_procedimiento},
                                                                                                                                                            identidad_confirmada = ${identidad_confirmada},
                                                                                                                                                                  embarazo_descartado = ${embarazo_descartado},
                                                                                                                                                                        fecha_test_embarazo = ${fecha_test_embarazo},
                                                                                                                                                                              lactancia_consultada = ${lactancia_consultada},
                                                                                                                                                                                    segunda_verificacion_responsable = ${segunda_verificacion_responsable},
                                                                                                                                                                                          bloqueo_tiroideo_considerado = ${bloqueo_tiroideo_considerado},
                                                                                                                                                                                                actividad_dentro_tolerancia = ${actividad_dentro_tolerancia},
                                                                                                                                                                                                      informacion_radioproteccion_entregada = ${informacion_radioproteccion_entregada},
                                                                                                                                                                                                            updated_at = now()
                                                                                                                                                                                                                WHERE id = ${id}
                                                                                                                                                                                                                    RETURNING *
                                                                                                                                                                                                                      `;
