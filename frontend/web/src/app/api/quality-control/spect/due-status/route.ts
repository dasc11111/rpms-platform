 ...
 * de Calidad, segun la frecuencia configurada en qc_spect_tolerances
 * (frequency_days). Misma logica que los endpoints analogos de Modulo 1
 * (Activimetro) y Modulo 2 (Gammacamara), aplicada a las dos pruebas
 * especificas de SPECT (Centro de Rotacion y Uniformidad Tomografica).
 *
