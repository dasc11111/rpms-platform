...
/**
 * MODULO 1 - ACTIVIMETRO
 * Endpoint de avisos anticipados y alertas de retraso de pruebas de Control
 * de Calidad, segun la frecuencia configurada en qc_activimetro_tolerances
 * (frequency_days). Requisito original: "avisar con anticipacion las veces
 * que se va a requerir hacer las pruebas y en caso que se lleve un retraso
 * dar un mensaje de alerta".
 *
