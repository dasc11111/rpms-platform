...
// Motor de coincidencias unificado: usa la misma clave de comparacion que el
// resto del modulo Trabajadores (rutMatchKey de @/lib/rut), tolerante a
// puntos, guion y a la presencia/ausencia del digito verificador, ya que los
// datasets de origen son inconsistentes con el formato del RUN.
...
// Sincronizacion automatica: refleja en workers.annual_dose la dosis
// acumulada del año en curso para cada trabajador afectado por esta carga.
