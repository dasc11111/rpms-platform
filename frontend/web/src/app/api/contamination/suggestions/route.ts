...
import { CONTAMINATION_SUGGESTION_FIELDS } from "@/lib/contamination";
...
// de la tabla contamination_field_suggestions, que crece con cada registro
// nuevo o editado (ver /api/contamination y /api/contamination/[id]).
