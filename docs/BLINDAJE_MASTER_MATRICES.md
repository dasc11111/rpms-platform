...
- **AAPM Task Group 108** — "PET and PET/CT Shielding Requirements", Madsen et al., Med. Phys. 33 (1), enero 2006 (recibido 21-jul-2005, publicado 19-dic-2005), DOI: 10.1118/1.2135911 → **medicina nuclear PET/PET-CT (§ nueva, hallazgo 16/09/2026)**. Verificado por apertura directa del archivo "TG108 AAPM REQUIRIMIENTOS DE BLINDAJE.txt" en Drive. Este es el documento primario específico para blindaje de PET/PET-CT (fotones de aniquilación de 0,511 MeV), directamente relevante para la rama actual `feature/fase23-petct-fase-a-arquitectura`. Aún NO implementado en un archivo de referencias TypeScript — ver Próximos pasos.

Estado: GAP-NORM-001 abierto. Nivel de confianza (§60): MEDIA para criterios de diseño de aceleradores/diagnóstico hasta que se incorpore normativa CCHEN vigente; ALTA para braquiterapia (SRS-47, Tablas 19-23, con verificación cruzada interna documentada en el archivo de referencias); ALTA para el hallazgo de AAPM TG-108 (documento releído directamente, cifras y autoría verificadas).
...
- **AAPM Task Group 108, "PET and PET/CT Shielding Requirements"** (2005/2006) — VERIFICADO (16/09/2026). Archivo: "TG108 AAPM REQUIRIMIENTOS DE BLINDAJE.txt".
...
4. Construir Fase 5-8 (clasificación de modalidades, motor matemático, base de materiales, motor de validación) sobre la base de datos ya creada en este branch (`feature/blindaje-diseno`) — EN PROGRESO. Próximo hito concreto: crear `aapm-tg108-petct-references.ts` (metodología y datos de AAPM TG-108 para blindaje de PET/PET-CT, recién verificado — ver arriba), dado que la rama actual (`feature/fase23-petct-fase-a-arquitectura`) tiene foco específico en PET-CT.
